...
; pocket ui: bookmark this for updating the ui to handle many types
;   i want to make it 2 rows
CardTypeFilters:
	db FILTER_GRASS
	db FILTER_FIRE
	db FILTER_WATER
...
; pocket ui: bookmark this
; move these fuckers around!
.CardTypeIcons
