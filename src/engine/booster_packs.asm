...
CardTypeTable:
	...
	db BOOSTER_CARD_TYPE_DARK
	db BOOSTER_CARD_TYPE_STEEL
	db BOOSTER_CARD_TYPE_DRAGON
	db BOOSTER_CARD_TYPE_COLORLESS ; TYPE_PKMN_COLORLESS
	db BOOSTER_CARD_TYPE_UNUSED
	...
	db BOOSTER_CARD_TYPE_ENERGY		; TYPE_ENERGY_DARK
	db BOOSTER_CARD_TYPE_ENERGY		; TYPE_ENERGY_STEEL
	db BOOSTER_CARD_TYPE_ENERGY		; TYPE_ENERGY_DRAGON
	db BOOSTER_CARD_TYPE_ENERGY    ; TYPE_ENERGY_COLORLESS
	db BOOSTER_CARD_TYPE_ENERGY   ; TYPE_ENERGY_UNUSED
	db BOOSTER_CARD_TYPE_TRAINER   ; TYPE_TRAINER
	db BOOSTER_CARD_TYPE_SUPPORTER   ; TYPE_SUPPORTER
	db BOOSTER_CARD_TYPE_TRAINER   ; TYPE_TRAINER_UNUSED
