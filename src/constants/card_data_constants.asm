...
; all card types
DEF CARD_DATA_TYPE                    EQU $00 ; is 1 byte, might need to be 2 for addtl types
DEF CARD_DATA_GFX                     EQU $01 ; 2 bytes
DEF CARD_DATA_NAME                    EQU $03 ; 2 bytes
DEF CARD_DATA_RARITY                  EQU $05 ; 1 byte
DEF CARD_DATA_SET                     EQU $06 ; 1 byte
DEF CARD_DATA_ID                      EQU $07 ; 1 byte
DEF CARD_DATA_EFFECT_COMMANDS         EQU $08 ; 0 bytes, just shows where this secion begins!TYPE_PKMN
DEF CARD_DATA_HP                      EQU $08 ; 1 byte TYPE_PKMN
DEF CARD_DATA_STAGE                   EQU $09 ; 1 byte TYPE_PKMN
DEF CARD_DATA_NONPKMN_DESCRIPTION     EQU $0a ; 0 bytes, not sure what this is!TYPE_PKMN
DEF CARD_DATA_PREEVO_NAME             EQU $0a ; 2 bytes TYPE_PKMN

DEF TRN_CARD_DATA_LENGTH    EQU $0e
DEF ENERGY_CARD_DATA_LENGTH EQU $0e

; TYPE_PKMN card only
DEF CARD_DATA_ATTACK1                 EQU $0c ; 0 bytes, jsut a marker
DEF CARD_DATA_ATTACK1_ENERGY_COST     EQU $0c ; 3 bytes?
DEF CARD_DATA_ATTACK1_NAME            EQU $10 ; 2 bytes
DEF CARD_DATA_ATTACK1_DESCRIPTION     EQU $12 ; 4 bytes
DEF CARD_DATA_ATTACK1_DAMAGE          EQU $16 ; 1 byte 
DEF CARD_DATA_ATTACK1_CATEGORY        EQU $17 ; 1 byte 
DEF CARD_DATA_ATTACK1_EFFECT_COMMANDS EQU $18 ; 2 bytes
DEF CARD_DATA_ATTACK1_FLAG1           EQU $1a ; 1 byte 
DEF CARD_DATA_ATTACK1_FLAG2           EQU $1b ; 1 byte 
DEF CARD_DATA_ATTACK1_FLAG3           EQU $1c ; 1 byte 
DEF CARD_DATA_ATTACK1_EFFECT_PARAM    EQU $1d ; 1 byte 
DEF CARD_DATA_ATTACK1_ANIMATION       EQU $1e ; 1 byte 

; TYPE_PKMN card only
DEF CARD_DATA_ATTACK2                 EQU $1f ; 0 bytes (marker)
DEF CARD_DATA_ATTACK2_ENERGY_COST     EQU $1f ; 4 bytes (2 for TYPE, 2 for NUM)
DEF CARD_DATA_ATTACK2_NAME            EQU $23 ; 2 bytes
DEF CARD_DATA_ATTACK2_DESCRIPTION     EQU $25 ; 4 bytes (2 separate, yeah)
DEF CARD_DATA_ATTACK2_DAMAGE          EQU $29 ; 1 byte 
DEF CARD_DATA_ATTACK2_CATEGORY        EQU $2a ; 1 byte 
DEF CARD_DATA_ATTACK2_EFFECT_COMMANDS EQU $2b ; 2 bytes 
DEF CARD_DATA_ATTACK2_FLAG1           EQU $2d ; 1 byte 
DEF CARD_DATA_ATTACK2_FLAG2           EQU $2e ; 1 byte 
DEF CARD_DATA_ATTACK2_FLAG3           EQU $2f ; 1 byte 
DEF CARD_DATA_ATTACK2_EFFECT_PARAM    EQU $30 ; 1 byte 
DEF CARD_DATA_ATTACK2_ANIMATION       EQU $31 ; 1 byte 
...
DEF DOUBLE_COLORLESS_F EQU $1 << COLORLESS
