...
DEF CARD_DATA_GFX                     EQU $02
DEF CARD_DATA_NAME                    EQU $04
DEF CARD_DATA_RARITY                  EQU $06
DEF CARD_DATA_SET                     EQU $07
DEF CARD_DATA_ID                      EQU $08
DEF CARD_DATA_EFFECT_COMMANDS         EQU $0A
DEF CARD_DATA_HP                      EQU $0A
DEF CARD_DATA_STAGE                   EQU $0B
DEF CARD_DATA_NONPKMN_DESCRIPTION     EQU $0C
DEF CARD_DATA_PREEVO_NAME             EQU $0C

DEF TRN_CARD_DATA_LENGTH    EQU $0d
DEF ENERGY_CARD_DATA_LENGTH EQU $0d

; TYPE_PKMN card only
DEF CARD_DATA_ATTACK1                 EQU $0E
DEF CARD_DATA_ATTACK1_ENERGY_COST     EQU $0E
DEF CARD_DATA_ATTACK1_NAME            EQU $12
DEF CARD_DATA_ATTACK1_DESCRIPTION     EQU $14
DEF CARD_DATA_ATTACK1_DAMAGE          EQU $18
DEF CARD_DATA_ATTACK1_CATEGORY        EQU $19
DEF CARD_DATA_ATTACK1_EFFECT_COMMANDS EQU $1A
DEF CARD_DATA_ATTACK1_FLAG1           EQU $1C
DEF CARD_DATA_ATTACK1_FLAG2           EQU $1D
DEF CARD_DATA_ATTACK1_FLAG3           EQU $1E
DEF CARD_DATA_ATTACK1_EFFECT_PARAM    EQU $1F
DEF CARD_DATA_ATTACK1_ANIMATION       EQU $20

; TYPE_PKMN card only
DEF CARD_DATA_ATTACK2                 EQU $21
DEF CARD_DATA_ATTACK2_ENERGY_COST     EQU $21
DEF CARD_DATA_ATTACK2_NAME            EQU $25
DEF CARD_DATA_ATTACK2_DESCRIPTION     EQU $27
DEF CARD_DATA_ATTACK2_DAMAGE          EQU $2B
DEF CARD_DATA_ATTACK2_CATEGORY        EQU $2C
DEF CARD_DATA_ATTACK2_EFFECT_COMMANDS EQU $2D
DEF CARD_DATA_ATTACK2_FLAG1           EQU $2F
DEF CARD_DATA_ATTACK2_FLAG2           EQU $30
DEF CARD_DATA_ATTACK2_FLAG3           EQU $31
DEF CARD_DATA_ATTACK2_EFFECT_PARAM    EQU $32
DEF CARD_DATA_ATTACK2_ANIMATION       EQU $33

; TYPE_PKMN card only
DEF CARD_DATA_RETREAT_COST            EQU $34
DEF CARD_DATA_WEAKNESS                EQU $35
; removing here...
;DEF CARD_DATA_RESISTANCE              EQU 
;DEF CARD_DATA_CATEGORY                EQU 
;DEF CARD_DATA_POKEDEX_NUMBER          EQU 
;DEF CARD_DATA_LEVEL                   EQU 
;DEF CARD_DATA_LENGTH                  EQU 
;DEF CARD_DATA_WEIGHT                  EQU 
;DEF CARD_DATA_PKMN_DESCRIPTION        EQU 
; ...through here
DEF CARD_DATA_PKMN_FLAGS              EQU $37

DEF PKMN_CARD_DATA_LENGTH EQU $38
...
DEF TYPE_ENERGY EQU const_value
	...
	const TYPE_ENERGY_DARK				; $0e
	const TYPE_ENERGY_STEEL
	const TYPE_ENERGY_DRAGON			; $0f
	const TYPE_ENERGY_COLORLESS			; $10
	const TYPE_ENERGY_DOUBLE_COLORLESS 	; $11
	const TYPE_ENERGY_UNUSED           	; $12
	const TYPE_TRAINER                 	; $13
	const TYPE_SUPPORTER				; $14
	const TYPE_TRAINER_UNUSED          	; $15
...
; card set constants (set 1)
	...
	const CARD_SET_GENETIC_APEX_P	; $4
	const CARD_SET_GENETIC_APEX_M	; $5
	const CARD_SET_GENETIC_APEX_C	; $6
	const CARD_SET_MYTHICAL_ISLAND	; $7
	const CARD_SET_PROMOTIONAL 		; $8
	const CARD_SET_ENERGY      		; $9
