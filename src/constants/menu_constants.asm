...
DEF NUM_FILTERED_LIST_VISIBLE_CARDS     EQU 5

DEF DB_TOTAL_CARD_COUNT_X				EQU 15
DEF DB_TOTAL_CARD_COUNT_Y				EQU 0
DEF DB_FILTERED_CARD_LIST_START_X		EQU 1
DEF DB_FILTERED_CARD_LIST_START_Y		EQU 8
DEF DB_GRASS_ICON_X						EQU 1
DEF DB_GRASS_ICON_Y						EQU 1
DEF DB_FIRE_ICON_X						EQU 4
DEF DB_FIRE_ICON_Y						EQU 1
DEF DB_WATER_ICON_X						EQU 7
DEF DB_WATER_ICON_Y						EQU 1
DEF DB_LIGHTNING_ICON_X					EQU 10
DEF DB_LIGHTNING_ICON_Y					EQU 1
DEF DB_FIGHTING_ICON_X					EQU 13
DEF DB_FIGHTING_ICON_Y					EQU 1
DEF DB_PSYCHIC_ICON_X					EQU 16
DEF DB_PSYCHIC_ICON_Y					EQU 1
DEF DB_DARK_ICON_X						EQU 1
DEF DB_DARK_ICON_Y						EQU 4
DEF DB_STEEL_ICON_X						EQU 4
DEF DB_STEEL_ICON_Y						EQU 4
DEF DB_DRAGON_ICON_X					EQU 7
DEF DB_DRAGON_ICON_Y					EQU 4
DEF DB_COLORLESS_ICON_X					EQU 10
DEF DB_COLORLESS_ICON_Y					EQU 4
DEF DB_TRAINER_ICON_X					EQU 13
DEF DB_TRAINER_ICON_Y					EQU 4
DEF DB_ENERGY_ICON_X					EQU 16
DEF DB_ENERGY_ICON_Y					EQU 4
