DEF NUM_CARDS_IN_BOOSTER EQU 10
	...
	const BOOSTER_CARD_TYPE_DARK 
	const BOOSTER_CARD_TYPE_STEEL 
	const BOOSTER_CARD_TYPE_DRAGON
	const BOOSTER_CARD_TYPE_COLORLESS ; $06
	const BOOSTER_CARD_TYPE_TRAINER   ; $07
	const BOOSTER_CARD_TYPE_ENERGY    ; $08
	const BOOSTER_CARD_TYPE_SUPPORTER
	const BOOSTER_CARD_TYPE_UNUSED
